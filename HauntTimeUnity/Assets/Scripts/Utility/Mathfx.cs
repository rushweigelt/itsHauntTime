...
public sealed class Mathfx
{
    ...
    public static double Hermite(double start, double end, float value)
    {
    ...
    public static double Sinerp(double start, double end, float value)
    {
    ...
    public static double Coserp(double start, double end, float value)
    {
    ...
    public static double Berp(double start, double end, float value)
    {
        value = Mathf.Clamp01(value);
        value = (Mathf.Sin(value * Mathf.PI * (0.2f + 2.5f * value * value * value)) * Mathf.Pow(1f - value, 2.2f) + value) * (1f + (1.2f * (1f - value)));
        return start + (end - start) * value;
    ...
    // Author: Drew Graham - 1/24/19
    // HANDY DOUBLE FUNCTIONS

    /// <summary>
    /// Clamp the specified double-precision value between min and max
    /// </summary>
